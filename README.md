...
(There are simpler versions of this device which do not need OLED display and dependencies: Refer to https://github.com/cobungra/cpocket-Chirp-Uploader-OLED)
